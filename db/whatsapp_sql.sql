--------------------------------------------------------------------------------
-- WHATSAPP (pagina APEX 117) — paquete + endpoints ORDS en un archivo.
-- Ejecutar completo como el esquema JOSEGALVEZ. Requiere PKG_AUTH_LUBRIMEC,
-- las tablas numeros_whatsapp / LOG_WHATSAPP (ver WHATSAPP_DDL.sql) y el
-- procedimiento ENVIAR_MENSAJES_WHATSAPP (ver PROC_ENVIAR_MENSAJES_WHATSAPP.sql).
--
-- === 1) PAQUETE PKG_WHATSAPP_LUBRIMEC ======================================
--------------------------------------------------------------------------------
